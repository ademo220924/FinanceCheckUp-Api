...
public class DashCpmNewOnGetGraphYearQuery : IUserIdAssignable , IRequest<GenericResult<DashCpmNewOnGetGraphYearResponse>>
{
    [JsonIgnore] public  string UserId { get; set; }
    public DashCpmNewOnGetGraphYearRequest Request { get; set; }
