...
public class SendMailInfoCommandHandle(IOptions<SmtpSettings> smtpSettings) : IRequestHandler<SendMailInfoCommand, GenericResult<NotificationSendMailResponse>>
{
    private readonly SmtpSettings _smtpSettings = smtpSettings.Value;

    public Task<GenericResult<NotificationSendMailResponse>> Handle(SendMailInfoCommand request, CancellationToken cancellationToken)
    {
        ...
        var message = new MailMessage
        {
            ...
            IsBodyHtml = true,
            Body = request.SendMailInfoRequest.emailsechomeinfo(),
