...
namespace FinanceCheckUp.Application.Features.BaseApp.Finance.Reports.ReportCheckZoneold.Query.GetReportMizanIV;

public class FinanceReportCheckZoneoldGetReportMizanIVQueryHandler(
    IReportCheckZoneManager reportCheckZoneManager,
    ICompanyManager companyManager)
    : IRequestHandler<FinanceReportCheckZoneoldGetReportMizanIVQuery, GenericResult<FinancialReportZonePayloadResponse>>
{
    public Task<GenericResult<FinancialReportZonePayloadResponse>> Handle(
        FinanceReportCheckZoneoldGetReportMizanIVQuery request,
