...
public class FinanceReportCheckZoneoldGetReportMivQueryHandler(
    IReportCheckZoneManager reportCheckZoneManager,
    ICompanyManager companyManager)
    : IRequestHandler<FinanceReportCheckZoneoldGetReportMIVQuery, GenericResult<FinancialReportZonePayloadResponse>>
{
    public Task<GenericResult<FinancialReportZonePayloadResponse>> Handle(
        FinanceReportCheckZoneoldGetReportMIVQuery request,
