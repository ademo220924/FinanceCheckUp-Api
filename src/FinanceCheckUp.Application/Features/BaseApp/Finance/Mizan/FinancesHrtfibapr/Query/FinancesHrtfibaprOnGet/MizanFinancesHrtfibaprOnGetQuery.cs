...
public class MizanFinancesHrtfibaprOnGetQuery : IUserIdAssignable , IRequest<GenericResult<MizanFinancesHrtfibaprOnGetResponse>>
{
    [JsonIgnore] public  string UserId { get; set; }
    public MizanFinancesHrtfibaprOnGetRequest Request { get; set; }
}
