...
namespace FinanceCheckUp.Application.Features.BaseApp.Finance.Mizan.UploadMzan.Query.UploadMzanOnGetSalerMainZeta
{
    public class MizanUploadMzanOnGetSalerMainZetaQueryHandler(
        ...
        ICompanyManager companyManager) : IRequestHandler<MizanUploadMzanOnGetSalerMainZetaQuery, GenericResult<MizanUploadMzanOnGetSalerMainZetaResponse>>
    {

        public Task<GenericResult<MizanUploadMzanOnGetSalerMainZetaResponse>> Handle(MizanUploadMzanOnGetSalerMainZetaQuery request, CancellationToken cancellationToken)
        {
