...
public class MizanDashBilancoMltOnGetQueryHandler(IDashGelirTablosuManager dashGelirTablosuManager,IHhvnUsersManager hhvnUsersManager, ICompanyManager companiesManager, IUserTypeManager userTypeManager, ICompanyManager companyManager, ITBLXmlManager tBLXmlManager) : IRequestHandler<MizanDashBilancoMltOnGetQuery, GenericResult<MizanDashBilancoMltOnGetResponse>>
{
    public Task<GenericResult<MizanDashBilancoMltOnGetResponse>> Handle(MizanDashBilancoMltOnGetQuery request, CancellationToken cancellationToken)
    {
        var userId = Convert.ToInt64(request.UserId);
        var responseModel = new MizanDashBilancoMltRequestInitialModel
        {
            UserID = userId,
        ...
        return Task.FromResult(GenericResult<MizanDashBilancoMltOnGetResponse>.Success(
            new MizanDashBilancoMltOnGetResponse
            {
