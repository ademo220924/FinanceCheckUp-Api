...
public class MizanReportMainTestMizanOldOnGetSalerYearQuery : IUserIdAssignable , IRequest<GenericResult<MizanReportMainTestMizanOldOnGetSalerYearResponse>>
{
    [JsonIgnore] public  string UserId { get; set; }
    public MizanReportMainTestMizanOldOnGetSalerYearRequest Request { get; set; }
}
