...
{
    public class MizanReportMainTestMizanOldOnGetCheckRepPdfQuery : IUserIdAssignable , IRequest<GenericResult<MizanReportMainTestMizanOldOnGetCheckRepPdfResponse>>
    {
