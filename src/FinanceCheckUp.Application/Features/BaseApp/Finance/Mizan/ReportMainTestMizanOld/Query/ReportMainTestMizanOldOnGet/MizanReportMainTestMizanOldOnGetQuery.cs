...
public class MizanReportMainTestMizanOldOnGetQuery : IUserIdAssignable , IRequest<GenericResult<MizanReportMainTestMizanOldOnGetResponse>>
{
    [JsonIgnore] public  string UserId { get; set; }
    public MizanReportMainTestMizanOldOnGetRequest Request { get; set; }
}
