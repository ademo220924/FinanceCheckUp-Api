...
{
    public class MizanUpBalanceNewOnGetQuery : IUserIdAssignable , IRequest<GenericResult<MizanUpBalanceNewOnGetResponse>>
    {
        [JsonIgnore] public  string UserId { get; set; }
        public MizanUpBalanceNewOnGetRequest Request { get; set; }
    }
}
