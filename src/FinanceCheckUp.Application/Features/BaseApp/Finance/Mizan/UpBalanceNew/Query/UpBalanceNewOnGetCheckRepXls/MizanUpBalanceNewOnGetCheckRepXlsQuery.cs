...
{
    public class MizanUpBalanceNewOnGetCheckRepXlsQuery : IUserIdAssignable , IRequest<GenericResult<MizanUpBalanceNewOnGetCheckRepXlsResponse>>
    {
        [JsonIgnore] public  string UserId { get; set; }
        public MizanUpBalanceNewOnGetCheckRepXlsRequest Request { get; set; }
