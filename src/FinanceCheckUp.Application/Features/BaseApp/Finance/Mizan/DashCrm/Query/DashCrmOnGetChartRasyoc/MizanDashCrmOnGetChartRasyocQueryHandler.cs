...
public class MizanDashCrmOnGetChartRasyocQueryHandler(IRasyoAnalizMainManager rasyoAnalizMainManager, IHhvnUsersManager hhvnUsersManager, ICompanyManager companyManager, ITBLXmlManager tBLXmlManager) : IRequestHandler<MizanDashCrmOnGetChartRasyocQuery, GenericResult<MizanDashCrmOnGetChartRasyocResponse>>
{
    ...
    public Task<GenericResult<MizanDashCrmOnGetChartRasyocResponse>> Handle(MizanDashCrmOnGetChartRasyocQuery request, CancellationToken cancellationToken)
    {
        ...
        request.InitialModel.RasyoAnalizCRM = rasyoAnalizMainManager.CRMAnalizTOTAL101Mizan(yearForCrm, request.InitialModel.CompID);
