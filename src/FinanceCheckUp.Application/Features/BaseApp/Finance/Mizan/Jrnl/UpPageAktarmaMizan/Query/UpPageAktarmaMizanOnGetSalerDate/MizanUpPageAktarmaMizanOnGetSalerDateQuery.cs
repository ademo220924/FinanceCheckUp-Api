...
{
    public class MizanUpPageAktarmaMizanOnGetSalerDateQuery : IUserIdAssignable , IRequest<GenericResult<MizanUpPageAktarmaMizanOnGetSalerDateResponse>>
    {
        [JsonIgnore] public  string UserId { get; set; }
        public MizanUpPageAktarmaMizanOnGetSalerDateRequest Request { get; set; }
