...
{
    public class MizanUpPageAktarmaMizanOnGetSalerDateMainQuery : IUserIdAssignable , IRequest<GenericResult<MizanUpPageAktarmaMizanOnGetSalerDateMainResponse>>
    {
