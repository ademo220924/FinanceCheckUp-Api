...
public class MizanUpPageAktarmaJrnlOnGetSalerDateCodeQuery : IUserIdAssignable , IRequest<GenericResult<MizanUpPageAktarmaJrnlOnGetSalerDateCodeResponse>>
{
    [JsonIgnore] public  string UserId { get; set; }
    public MizanUpPageAktarmaJrnlOnGetSalerDateCodeRequest Request { get; set; }
