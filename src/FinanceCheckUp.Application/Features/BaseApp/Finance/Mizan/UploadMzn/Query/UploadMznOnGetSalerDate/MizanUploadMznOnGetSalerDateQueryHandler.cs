...
{
    public class MizanUploadMznOnGetSalerDateQueryHandler(
        IMainDashManager mainDashManager,
        IUploadMainManager uploadMainManager,
        IHhvnUsersManager hhvnUsersManager, 
        ICompanyManager companyManager) : IRequestHandler<MizanUploadMznOnGetSalerDateQuery, GenericResult<MizanUploadMznOnGetSalerDateResponse>>
    {
        public Task<GenericResult<MizanUploadMznOnGetSalerDateResponse>> Handle(MizanUploadMznOnGetSalerDateQuery request, CancellationToken cancellationToken)
        { 
            ...
            return Task.FromResult(GenericResult<MizanUploadMznOnGetSalerDateResponse>.Success(new MizanUploadMznOnGetSalerDateResponse
            {
