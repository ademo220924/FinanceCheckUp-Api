...
public class MizanFinanceHrtViewOnGetQuery : IUserIdAssignable , IRequest<GenericResult<MizanFinanceHrtViewOnGetResponse>>
{
    [JsonIgnore] public  string UserId { get; set; }
    public MizanFinanceHrtViewOnGetRequest Request { get; set; }
}
