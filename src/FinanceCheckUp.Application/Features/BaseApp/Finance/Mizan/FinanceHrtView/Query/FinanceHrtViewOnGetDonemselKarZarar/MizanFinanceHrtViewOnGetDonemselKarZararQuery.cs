...
public class MizanFinanceHrtViewOnGetDonemselKarZararQuery : IUserIdAssignable , IRequest<GenericResult<MizanFinanceHrtViewOnGetDonemselKarZararResponse>>
{
    [JsonIgnore] public  string UserId { get; set; }
    public MizanFinanceHrtViewOnGetDonemselKarZararRequest Request { get; set; }
}
