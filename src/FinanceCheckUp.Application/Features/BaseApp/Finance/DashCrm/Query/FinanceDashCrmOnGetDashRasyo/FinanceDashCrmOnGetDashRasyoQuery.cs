...
public class FinanceDashCrmOnGetDashRasyoQuery : IUserIdAssignable , IRequest<GenericResult<FinanceDashCrmOnGetDashRasyoResponse>>
{
    [JsonIgnore] public  string UserId { get; set; }
    public FinanceDashCrmOnGetDashRasyoRequest Request { get; set; }
