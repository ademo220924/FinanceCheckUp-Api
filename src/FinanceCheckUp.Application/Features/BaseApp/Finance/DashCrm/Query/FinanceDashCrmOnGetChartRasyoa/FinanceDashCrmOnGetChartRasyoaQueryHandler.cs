...
public class FinanceDashCrmOnGetChartRasyoaQueryHandler(IHhvnUsersManager hhvnUsersManager, 
    ICompanyManager companiesManager, 
    IRasyoAnalizMainManager rasyoAnalizMainManager) : IRequestHandler<FinanceDashCrmOnGetChartRasyoaQuery, GenericResult<FinanceDashCrmOnGetChartRasyoaResponse>>
{
    public Task<GenericResult<FinanceDashCrmOnGetChartRasyoaResponse>> Handle(FinanceDashCrmOnGetChartRasyoaQuery request, CancellationToken cancellationToken)
    {
        ...
        request.InitialModel.RasyoAnalizCRM = rasyoAnalizMainManager.CRMAnalizTOTAL103(request.InitialModel.CurrentUser.SelectedYear, request.InitialModel.CompID);
        request.InitialModel.RasyoAnalizViewCrm.SetResult(request.InitialModel.RasyoAnalizCRM, request.InitialModel.CurrentUser.SelectedYear);
                ...
                return Task.FromResult(GenericResult<FinanceDashCrmOnGetChartRasyoaResponse>.Success(new FinanceDashCrmOnGetChartRasyoaResponse
        {
