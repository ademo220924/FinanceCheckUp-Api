...
public class FinanceUploadMainOnGetSalerMainChkQueryHandler(
    IMainDashManager mainDashManager, 
    IHhvnUsersManager hhvnUsersManager, 
    ICompanyManager companyManager) : IRequestHandler<FinanceUploadMainOnGetSalerMainChkQuery, GenericResult<FinanceUploadMainOnGetSalerMainChkResponse>>
{

    public Task<GenericResult<FinanceUploadMainOnGetSalerMainChkResponse>> Handle(FinanceUploadMainOnGetSalerMainChkQuery request, CancellationToken cancellationToken)
    {
        var mrequestDataViewer = new DataViewerMain();
        if (request.Request.monthid < 1)
        {
            return Task.FromResult(GenericResult<FinanceUploadMainOnGetSalerMainChkResponse>.Success(new FinanceUploadMainOnGetSalerMainChkResponse
            {
