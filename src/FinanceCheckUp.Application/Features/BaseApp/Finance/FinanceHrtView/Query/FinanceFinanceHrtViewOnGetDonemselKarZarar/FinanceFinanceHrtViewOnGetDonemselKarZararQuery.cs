...
public class FinanceFinanceHrtViewOnGetDonemselKarZararQuery : IUserIdAssignable , IRequest<GenericResult<FinanceFinanceHrtViewOnGetDonemselKarZararResponse>>
{
