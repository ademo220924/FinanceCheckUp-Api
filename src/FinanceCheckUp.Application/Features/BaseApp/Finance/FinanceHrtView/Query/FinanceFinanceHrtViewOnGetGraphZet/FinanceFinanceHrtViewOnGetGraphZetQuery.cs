...
public class FinanceFinanceHrtViewOnGetGraphZetQuery : IUserIdAssignable , IRequest<GenericResult<FinanceFinanceHrtViewOnGetGraphZetResponse>>
{
    [JsonIgnore] public  string UserId { get; set; }
    public FinanceFinanceHrtViewOnGetGraphZetRequest Request { get; set; }
