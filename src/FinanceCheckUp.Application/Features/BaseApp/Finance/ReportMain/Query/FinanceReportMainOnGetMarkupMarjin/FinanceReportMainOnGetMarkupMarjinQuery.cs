...
public class FinanceReportMainOnGetMarkupMarjinQuery : IUserIdAssignable , IRequest<GenericResult<FinanceReportMainOnGetMarkupMarjinResponse>>
{
    [JsonIgnore] public  string UserId { get; set; }
    public FinanceReportMainOnGetMarkupMarjinRequest Request { get; set; }
}
