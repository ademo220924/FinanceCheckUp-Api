...
public class FinanceFinanceHrtOnGetChartRasyoQueryHandler(
    ...
    IDashGelirTablosuManager dashGelirTablosuManager) : IRequestHandler<FinanceFinanceHrtOnGetChartRasyoQuery, GenericResult<FinanceFinanceHrtOnGetChartRasyoResponse>>
{
    public Task<GenericResult<FinanceFinanceHrtOnGetChartRasyoResponse>> Handle(FinanceFinanceHrtOnGetChartRasyoQuery request, CancellationToken cancellationToken)
    {
