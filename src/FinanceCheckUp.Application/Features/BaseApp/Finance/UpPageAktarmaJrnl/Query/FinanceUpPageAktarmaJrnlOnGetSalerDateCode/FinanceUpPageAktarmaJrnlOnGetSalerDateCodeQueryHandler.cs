...
public class FinanceUpPageAktarmaJrnlOnGetSalerDateCodeQueryHandler(
    ITblxmJournalFileManager tblxmJournalFileManager,
    IHhvnUsersManager hhvnUsersManager,
    ICompanyManager companyManager) : IRequestHandler<FinanceUpPageAktarmaJrnlOnGetSalerDateCodeQuery, GenericResult<FinanceUpPageAktarmaJrnlOnGetSalerDateCodeResponse>>
{

    public Task<GenericResult<FinanceUpPageAktarmaJrnlOnGetSalerDateCodeResponse>> Handle(FinanceUpPageAktarmaJrnlOnGetSalerDateCodeQuery request, CancellationToken cancellationToken)
    {
        ...
        var options = new DataSourceLoadOptions();
                ...
                return Task.FromResult(GenericResult<FinanceUpPageAktarmaJrnlOnGetSalerDateCodeResponse>.Success(new FinanceUpPageAktarmaJrnlOnGetSalerDateCodeResponse
        {
