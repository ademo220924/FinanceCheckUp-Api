...
public class upaccountOnGetGraphYearQuery : IUserIdAssignable , IRequest<GenericResult<upaccountOnGetGraphYearResponse>>
{
    [JsonIgnore] public  string UserId { get; set; }
    public upaccountOnGetGraphYearRequest Request { get; set; }
