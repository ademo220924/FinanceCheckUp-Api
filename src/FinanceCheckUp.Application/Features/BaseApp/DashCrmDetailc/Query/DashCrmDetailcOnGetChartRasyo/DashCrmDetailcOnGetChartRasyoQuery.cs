...
public class DashCrmDetailcOnGetChartRasyoQuery : IUserIdAssignable , IRequest<GenericResult<DashCrmDetailcOnGetChartRasyoResponse>>
{
    [JsonIgnore] public  string UserId { get; set; }
    public DashCrmDetailcOnGetChartRasyoRequest Request { get; set; }
