...
public class upreportmainyOnGetGraphCompQuery : IUserIdAssignable , IRequest<GenericResult<upreportmainyOnGetGraphCompResponse>>
{
    [JsonIgnore] public  string UserId { get; set; }
    public upreportmainyOnGetGraphCompRequest Request { get; set; }
