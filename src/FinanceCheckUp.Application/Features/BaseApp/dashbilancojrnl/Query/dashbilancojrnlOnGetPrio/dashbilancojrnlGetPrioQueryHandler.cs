...
public class dashbilancojrnlOnGetPrioQueryHandler : IRequestHandler<dashbilancojrnlOnGetPrioQuery, GenericResult<dashbilancojrnlOnGetPrioResponse>>
{
    ...
    {
                return GenericResult<dashbilancojrnlOnGetPrioResponse>.Success(new dashbilancojrnlOnGetPrioResponse { Result = DataSourceLoader.Load(AppConst.PriorityResources, request.Request.DataSourceLoadOptions) });
    }
}