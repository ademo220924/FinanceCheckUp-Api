...
public class dashbilancorvnmltOnGetGraphYearQuery : IUserIdAssignable , IRequest<GenericResult<dashbilancorvnmltOnGetGraphYearResponse>>
{
    [JsonIgnore] public  string UserId { get; set; }
    public dashbilancorvnmltOnGetGraphYearRequest Request { get; set; }
