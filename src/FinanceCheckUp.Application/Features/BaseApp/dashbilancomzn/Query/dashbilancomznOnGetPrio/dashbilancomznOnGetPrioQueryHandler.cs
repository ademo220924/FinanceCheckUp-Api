...
public class dashbilancomznOnGetPrioQueryHandler : IRequestHandler<dashbilancomznOnGetPrioQuery, GenericResult<dashbilancomznOnGetPrioResponse>>
{
    ...
    {
        return GenericResult<dashbilancomznOnGetPrioResponse>.Success(new dashbilancomznOnGetPrioResponse { Result = new JsonResult(DataSourceLoader.Load(AppConst.PriorityResources, request.Request.DataSourceLoadOptions)) });
    }
}