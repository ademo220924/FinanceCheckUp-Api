...
public class DashCrmDetailOnGetChartRasyoQueryHandler(
    ...
    IRasyoAnalizMainManager rasyoAnalizMainManager) : IRequestHandler<DashCrmDetailOnGetChartRasyoQuery, GenericResult<DashCrmDetailOnGetChartRasyoResponse>>
{

    public async Task<GenericResult<DashCrmDetailOnGetChartRasyoResponse>> Handle(DashCrmDetailOnGetChartRasyoQuery request, CancellationToken cancellationToken)
    {
