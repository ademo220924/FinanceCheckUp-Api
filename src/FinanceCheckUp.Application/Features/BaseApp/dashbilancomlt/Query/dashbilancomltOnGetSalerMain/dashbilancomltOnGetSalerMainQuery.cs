...
public class dashbilancomltOnGetSalerMainQuery : IUserIdAssignable , IRequest<GenericResult<dashbilancomltOnGetSalerMainResponse>>
{
    [JsonIgnore] public  string UserId { get; set; }
    public dashbilancomltOnGetSalerMainRequest Request { get; set; }
