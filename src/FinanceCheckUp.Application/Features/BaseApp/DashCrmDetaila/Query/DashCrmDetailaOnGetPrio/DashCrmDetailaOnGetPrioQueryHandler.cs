...
public class DashCrmDetailaOnGetPrioQueryHandler : IRequestHandler<DashCrmDetailaOnGetPrioQuery, GenericResult<DashCrmDetailaOnGetPrioResponse>>
{
    ...
    {
                return GenericResult<DashCrmDetailaOnGetPrioResponse>.Success(new DashCrmDetailaOnGetPrioResponse { Response = DataSourceLoader.Load(AppConst.PriorityResources, request.Request.Options) });
    }
}