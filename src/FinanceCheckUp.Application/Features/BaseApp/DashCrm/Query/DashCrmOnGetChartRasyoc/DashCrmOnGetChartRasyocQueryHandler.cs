...
public class DashCrmOnGetChartRasyocQueryHandler(
     IHhvnUsersManager hhvnUsersManager,
    ICompanyManager companyManager,
    IRasyoAnalizMainManager rasyoAnalizMainManager) : IRequestHandler<DashCrmOnGetChartRasyocQuery, GenericResult<DashCrmOnGetChartRasyocResponse>>
{

    public async Task<GenericResult<DashCrmOnGetChartRasyocResponse>> Handle(DashCrmOnGetChartRasyocQuery request, CancellationToken cancellationToken)
    {
        ...
        return GenericResult<DashCrmOnGetChartRasyocResponse>.Success(new DashCrmOnGetChartRasyocResponse { Response = new JsonResult(DataSourceLoader.Load(request.Request.InitialModel.RasyoAnalizViewCrm.nresult.OrderByDescending(z => z.Value), request.Request.Options)) });
    }
}