...
public class LayoutFinanceMizanQueryHandler(IHhvnUsersManager hhvnUsersManager, IUserManager userManager)
    : IRequestHandler<LayoutFinanceMizanQuery, GenericResult<LayoutFinanceMizanResponse>>
{
    public Task<GenericResult<LayoutFinanceMizanResponse>> Handle(LayoutFinanceMizanQuery request,
        CancellationToken cancellationToken)
    {
        var layoutResponse = new LayoutFinanceMizanResponse
        {
            IsConsole = false,
        ...
        return Task.FromResult(GenericResult<LayoutFinanceMizanResponse>.Success(layoutResponse));
    }
}