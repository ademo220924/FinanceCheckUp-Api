...
public interface IDashGelirTablosuMizanManager
{
    public List<DashBilancoViewMizan> getListBYN(int _year, long _compID);
    public List<DashBilancoViewMizan> getList(int _year, long _compID);
}

public class DashGelirTablosuMizanManager(
IDashGelirTablosuViewTManager dashGelirTablosuViewTManager,
    IDashGelirTablosuSetManager dashGelirTablosuSetManager) : IDashGelirTablosuMizanManager
{
    public List<DashBilancoViewMizan> getListBYN(int _year, long _compID)
    {
        ...
        nCheck = dashGelirTablosuViewTManager.SetBilancoHeaderT(nCheck, dashGelirTablosuSetManager.Get_OlaganKarZaraTByn(_year, _compID), "Z-DÖNEM KARI/ZARARI", 9991, 0);
        ...
        nCheck = dashGelirTablosuViewTManager.SetBilancoHeaderT(nCheck, dashGelirTablosuSetManager.Get_DonemKarZaraTNetByn(_year, _compID), "ZT-DÖNEM NET KARI/ZARARI", 9995, 0);
