...
{
    public interface IDashGelirTablosuViewMainManager
    {
        public List<DashBilancoView> getList(int _year, long _compID);
    }


    public class DashGelirTablosuViewMainManager(IDashGelirTablosuViewTManager dashGelirTablosuViewTManager, IDashGelirTablosuSetManager dashGelirTablosuSetManager) : IDashGelirTablosuViewMainManager
    {
        public List<DashBilancoView> getList(int _year, long _compID)
        {
