...
public interface IDashBilancoSetQnbCSqlOperationManager : IGenericDapperRepository
{
...
public class DashBilancoSetQnbCSqlOperationManager(FinanceCheckUpDbContext _dbContext) : GenericDapperRepositoryBase(_dbContext), IDashBilancoSetQnbCSqlOperationManager
{
