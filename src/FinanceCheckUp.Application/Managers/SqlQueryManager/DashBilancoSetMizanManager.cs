...
public interface IDashBilancoSetMizanManager : IGenericDapperRepository
{
    ...
    public int Set_ReportSetResetMizanKayitMOnth(int _year, long _compID, byte _mon);
    ...
    public List<DashBilancoViewMizan> Get_OKynkDonemKZTByn(int _year, long _compID);
    public List<DashBilancoViewMizan> Get_TOPLAMPasif(int _year, long _compID);
    public List<DashBilancoViewMizan> Get_TOPLAMPasifBynNw(int _year, long _compID);
...
public class DashBilancoSetMizanManager(FinanceCheckUpDbContext _dbContext) : GenericDapperRepositoryBase(_dbContext), IDashBilancoSetMizanManager
{
    public int Set_ReportSetMainSMM(int _year, long _compID)
    {
        try
    ...
    public int Set_ReportSetResetMizanKayitMOnth(int _year, long _compID, byte _mon)
    {
        ...
        return Execute("Delete FROM [TBLXMLSourceOneBck] where CompanyID=@companyID and Year=@nyear and IsBeyan=0 and MainMonth=@nmonth", new { nyear = _year, companyID = _compID, nmonth = _mon });
    ...
    public List<DashBilancoViewMizan> Get_TOPLAMT(int _year, long _compID)
    {
        return StaticQuery<DashBilancoViewMizan>("EXEC SP_Main_Grow_HeaderMain__MizanV1 @companyID, @nyear,3", new { nyear = _year, companyID = _compID }).ToList();
    }
    ...
    public List<DashBilancoViewMizan> Get_TOPLAMTU(int _year, long _compID)
    {
        ...
        return StaticQuery<DashBilancoViewMizan>("EXEC SP_Main_Grow_HeaderMain__MizanV1 @companyID, @nyear,4", new { nyear = _year, companyID = _compID }).ToList();
    }
    public List<DashBilancoViewMizan> Get_OKynkOdSermayeT(int _year, long _compID)
    {
